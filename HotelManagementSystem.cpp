...
// Total price of items
 ...
 m:
  ...
  case 1:
    ...
    cout<<"\n\t Soory only "<<(Qrooms- Srooms)<<"room are remaining in hotel.";
    break;
  ...
  case 2:
    ...
    cout<<"\n\t Soory only "<<(Qpasta- Spasta)<<"pasta are remaining in hotel.";
    break;
    ...
    cout<<"\n\t Soory only "<<(Qburger- Sburger)<<"burger are remaining in hotel.";
    break;
    ...
    cout<<"\n\t Soory only "<<(Qnoodles- Snoodles)<<"noodles are remaining in hotel.";
    break;
    ...
    cout<<"\n\t Soory only "<<(Qshake - Sshake)<<"shake are remaining in hotel.";
    break;
    ...
    cout<<"\n\t Soory only "<<(Qchicken - Schicken)<<"shake are remaining in hotel.";
    break;
    ...
    cout<<"\n\n Remaining chicken  : "<<Qshake-Schicken ;
